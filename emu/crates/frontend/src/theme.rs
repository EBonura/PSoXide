...
//! Same palette and typography across both debug panels and the XMB overlay
...
// --- XMB-specific palette (from psoxide-1 xmb.rs) ---

/// XMB backdrop overlay (dims the game below).
pub const XMB_BACKDROP: Color32 = Color32::from_rgba_premultiplied(0, 0, 0, 128);
/// XMB accent (selected category icon + selection bar).
pub const XMB_ACCENT: Color32 = Color32::from_rgb(0, 191, 230);
pub const XMB_TEXT_BRIGHT: Color32 = Color32::from_rgb(230, 230, 230);
pub const XMB_TEXT_DIM: Color32 = Color32::from_rgb(128, 128, 140);
pub const XMB_TEXT_VALUE: Color32 = Color32::from_rgb(179, 179, 191);
pub const XMB_HINT: Color32 = Color32::from_rgb(102, 102, 115);
pub const XMB_ITEM_BG: Color32 = Color32::from_rgba_premultiplied(25, 25, 30, 234);
pub const XMB_ITEM_SEL: Color32 = Color32::from_rgba_premultiplied(0, 38, 51, 242);
