...
- **Frontend** — winit + wgpu + egui desktop app with XMB menu, audio output via cpal, live register / VRAM / memory panels with breakpoints, continuous-run mode, HUD metrics (FPS / MIPS / dt / audio-queue), debug-toggle toolbar cluster.
