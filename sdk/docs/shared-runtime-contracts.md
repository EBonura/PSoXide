...
| `psx_math::attributed_clip` | engine reexport, VoXide, HL, CS, DS | Existing allocation-free traversal moved unchanged; caller adapters retain distance arithmetic, interpolation, deduplication and vertex order. No dynamic dispatch. |
