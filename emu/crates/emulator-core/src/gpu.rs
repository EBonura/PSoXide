...
pub struct Gpu {
    ...
    /// that never repaint their background (Gran Turismo's menus draw
    ...
    /// overdrew our edge (Tekken's leaderboard redraws its text rows),
    ...
    /// for the rest of the session (GT races / Tekken fights looked
