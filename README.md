...
- **Frontend**: winit + wgpu + egui desktop app with a PS3-style XMB menu, live register/VRAM/memory panels, breakpoints, exec history, continuous-run mode, and an HUD overlay. See [docs/frontend.md](docs/frontend.md) for the architecture.
...
- **[psoxide](../psoxide)**: mature CPU, full SDK, working frontend. Stalled on the exponential-tail work of commercial-game parity. Its XMB menu and HUD bar patterns live on here.
