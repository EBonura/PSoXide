...
use psx_engine::{
    ...
    ThirdPersonCameraState, ThirdPersonCameraTarget, TombRaiderSubdivisionKindMask, VideoHz,
...
use generated::{
    ASSETS, BOX_PROPS, BOX_PROP_SURFACES, CACHED_ROOM_DEPTH_MODE, CACHED_ROOM_DRAW_ORDER_MODE,
    ...
    ROOM_CACHE_CELL_VERTICES, ROOM_CACHE_SURFACES, ROOM_CACHE_VERTICES, ROOM_CHUNKS,
    ROOM_OVERLAPPED_ROOMS, ROOM_PORTALS, ROOM_REFLECTION_PROBES, ROOM_RESIDENCY,
    ROOM_SURFACE_CACHES, ROOM_VISIBILITY, UI_FONTS, UI_NODES, UI_PAINTS, UI_SFX_CUES,
    UI_SFX_SAMPLES, VISIBILITY_CELLS, WATER_CELLS, WEAPONS, WEAPON_HITBOXES,
};
#[cfg(feature = "cd-stream-bench")]
use generated::{
