...
fn frontend_display(
    ...
    // target is BGR15 and can't represent 24bpp pre-rendered backgrounds (RE2/RE3
    ...
    // path, so a game with a constant 1px pan (RE3 h_off=-1, MGS h_off=-1/v_off=8)
    // silently lost hi-res while an offset-free sibling (RE2) kept it.
