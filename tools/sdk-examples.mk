...
examples:
	@set -e; for example in hello-tri hello-input hello-ot hello-gte hello-tex hello-memcard hello-spstack hello-gteirq hello-faultbd hello-present; do $(MAKE) -f tools/sdk-examples.mk disc EXAMPLE=$$example; done
