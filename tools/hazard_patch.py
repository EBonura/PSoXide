...
mipsel-none-elf-objdump on PATH, or another one named in OBJDUMP. Detection
is tools/hazard_detect.py, shared with hazard_scan.py so the two cannot drift;
a game calls the SDK's copy from its hydrated `.psoxide/tools/` instead of
vendoring this file.
"""
import os
import re
...
from hazard_detect import (COND, HEADER, JUMPS, disassemble, find_hazards,  # noqa: E402
                           load_address, load_destination, looks_like_code)
