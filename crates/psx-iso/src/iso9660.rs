...
/// - 280 EDC/ECC bytes
///
/// PSoXide-3's emulator CDROM path expects raw sectors; external
...
impl IsoBuilder {
    ...
    /// bytes are left zero: PSoXide-3's CDROM emulation and most
    /// desktop emulators don't verify them, and a real PS1 lens
    /// hardware re-computes ECC on the fly.
    ///
    /// Use this output for PSoXide-3's disc loader (`Disc::from_bin`)
