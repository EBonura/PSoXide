...
//!
//! This replicates the EXACT sequence the XMB uses when the user
...
//!
//! ```bash
//! cargo run -p emulator-core --example probe_xmb_launch_sim --release -- hello-tri
//! cargo run -p emulator-core --example probe_xmb_launch_sim --release -- hello-gte
//! ```
...
fn main() {
    ...
    let exe_path = PathBuf::from("/Users/ebonura/Desktop/repos/PSoXide-3/build/examples/mipsel-sony-psx/release")
