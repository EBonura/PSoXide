...
hardware and the visual guards are the accuracy oracle now). The recorded
first-divergence evidence remains valid leads for compatibility work. Test
media must come from legally owned discs or already-authorized preservation
images.
