...
//! * `obj-NxN`: uniform subdivision in object space -- what Tomb Raider does,
//!   and what `render3d.rs`'s `tomb_raider_subdivision` does today.
...
/// Uniform in object space: what naive / Tomb Raider-style subdivision does.
